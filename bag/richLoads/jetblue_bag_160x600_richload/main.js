...
function animate() {
  ...
  tl.addLabel('start', 0)
    ...
    .staggerFrom(['#copy1-1', '#copy1-2', '#copy1-3', '#copy1-4'], 0.8, { y: '+=100', ease: "expo.out" }, 0.1, 'start+=2')
    .to(['#copy1'], 0.5, { alpha: 0, delay: 2 })
    .staggerTo(['#copy2-1', '#copy2-2', '#copy2-3'], 0.8, { autoAlpha: 1, ease: "expo.out" }, 0.1, 'start+=5.5')
    .staggerFrom(['#copy2-1', '#copy2-2', '#copy2-3'], 0.8, { y: '+=100', ease: "expo.out" }, 0.1, 'start+=5.5')
